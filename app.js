...
const HELP = {
  ...
  data: { title: "収録データについて（重要）", body: `
    ...
    <ul>
      <li><b>用語選択シート（2種類）</b> — 「ワイン受験.com 2026年版」はワイン受験.com公開の「テイスティング解答用紙 2026年版」（白・赤）に、「Wine-Flight 2025年版」はWine-Flight公開の「2025年版テイスティング用語選択シート（白・赤）」に、それぞれ項目・用語・並び順を準拠しています。模範解答はワイン受験.com版の用語で作られており、Wine-Flight版で採点するときは用語を自動で読み替えます（シートにない用語は採点対象外）。各項目の「いくつ選べ」の数は本番で年やワインにより変わるため、ワイン受験.com版は本アプリ独自の目安、Wine-Flight版は同サイトの「2025年版テイスティングマークシート」に記載の選択可能数（白・赤とも同じ）に合わせています。ただし<b>グラス</b>だけは2025年の試験から「大きさ1つ＋形1つ」の2語指定になったため、両シートともその形にしています</li>
